...
async function education(categoryId) {
    const url = `https://www.googleapis.com/youtube/v3/search?part=snippet&type=video&videoCategoryId=${categoryId}&regionCode=IN&maxResults=50&key=${apiKey}`
